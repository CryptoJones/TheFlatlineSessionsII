...
**Scaffold complete, art and music pending.** The whole story is playable end to end with
placeholder plates (each room shows a hue-keyed panel + name watermark until its art lands
in `assets/backgrounds_hd/<bg>.png`). All dialog, quests, items, shops, and matrix targets
are in place, written in the novel's tone — our own prose throughout.
