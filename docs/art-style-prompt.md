...
Use per-room prompts as factual scene descriptions, then wrap them with this
style. Do not prompt by name-dropping a living director; describe the visual
grammar instead.
